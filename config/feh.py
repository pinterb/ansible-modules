...
#        self.module.fail_json(msg="IN valid value")
...
#    def put(self, key, value):
    def put(self):
#        self.module.fail_json(msg="IN PUT")
...
def main():
    ...
    if state == 'present':
#        op_status, kvs_changed  = backend.put("blah", "rah")
#    	module.fail_json(msg="back from first put")
        try:
